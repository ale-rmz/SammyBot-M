...
const handler = async (m, {conn, text, participants, args}) => {
  ...
  try {
    ...
    for (const user of participant.filter((item) => item.attrs.error == 403)) {
      ...
      const captionn = `Hey!! Hola, me presento, soy Goku - Bot, y soy un Bot para WhatsApp, una persona del grupo utilizo el comando para añadirte al grupo, pero no pude agregarte, asi que te mando la invitacion para que te agregues, te esperamos!!`;
