...
—◉ *Contacto para apelaciones:* wa.me/5493585753625
╚═════════════════════════╝
               `.trim();
              m.reply(messageText);
  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        ...
        const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;𝘼𝙡𝙚𝙚👑;;;\nFN:𝘼𝙡𝙚𝙚👑\nORG:𝘼𝙡𝙚𝙚👑\nTITLE:\nitem1.TEL;waid=543585753625+543585753625\nitem1.X-ABLabel:𝘼𝙡𝙚𝙚👑\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:𝘈𝘭𝘦𝘦👑\nEND:VCARD`;
        await this.sendMessage(nk.from, {contacts: {displayName: '𝗔𝗹𝗲𝗲👑', contacts: [{vcard}]}}, {quoted: callmsg});
...
global.dfail = (type, m, conn) => {
  const msg = {
    rowner: '[🧸𝗔𝗗𝗩𝗘𝗥𝗧𝗘𝗡𝗖𝗜𝗔🧸] 𝑬𝑺𝑻𝑬 𝑪𝑶𝑴𝑨𝑵𝑫𝑶 𝑬𝑺 𝑺𝑶𝑳𝑶 𝑷𝑨𝑹𝑨 𝑶𝑾𝑵𝑬𝑹𝑺 𝑶 𝑺𝑻𝑨𝑭𝑭 𝑫𝑬 𝑺𝑨𝑴𝑴𝒀-𝑩𝑶𝑻-𝑴𝑫',
    owner: '[🧸𝗔𝗗𝗩𝗘𝗥𝗧𝗘𝗡𝗖𝗜𝗔🧸] 𝑬𝑺𝑻𝑬 𝑪𝑶𝑴𝑨𝑵𝑫𝑶 𝑬𝑺 𝑺𝑶𝑳𝑶 𝑷𝑨𝑹𝑨 𝑶𝑾𝑵𝑬𝑹𝑺 𝑶 𝑺𝑻𝑨𝑭𝑭 𝑫𝑬 𝑺𝑨𝑴𝑴𝒀-𝑩𝑶𝑻-𝑴𝑫',
    mods: '[🧸𝗔𝗗𝗩𝗘𝗥𝗧𝗘𝗡𝗖𝗜𝗔🧸] 𝑬𝑺𝑻𝑬 𝑪𝑶𝑴𝑨𝑵𝑫𝑶 𝑬𝑺 𝑺𝑶𝑳𝑶 𝑷𝑨𝑹𝑨 𝑶𝑾𝑴𝑬𝑹𝑺 𝑶 𝑺𝑻𝑨𝑭𝑭 𝑫𝑬 𝑺𝑨𝑴𝑴𝒀-𝑩𝑶𝑻-𝑴𝑫',
    premium: '[🧸𝗔𝗗𝗩𝗘𝗥𝗧𝗘𝗡𝗖𝗜𝗔🧸] 𝑬𝑺𝑻𝑬 𝑪𝑶𝑴𝑨𝑵𝑫𝑶 𝑬𝑺 𝑷𝑨𝑹𝑨 𝑶𝑾𝑵𝑬𝑹𝑺,𝑺𝑻𝑨𝑭𝑭 𝒀 𝑼𝑺𝑼𝑨𝑹𝑰𝑶𝑺 𝑽𝑰𝑷 𝑫𝑬 𝑺𝑨𝑴𝑴𝒀-𝑩𝑶𝑻-𝑴𝑫',
    group: '[🧸𝗔𝗗𝗩𝗘𝗥𝗧𝗘𝗡𝗖𝗜𝗔🧸] 𝑬𝑳 𝑪𝑶𝑴𝑨𝑵𝑫𝑶 𝑬𝑺 𝑬𝑱𝑬𝑪𝑼𝑻𝑨𝑫𝑶 𝑺𝑶𝑳𝑶 𝑬𝑺 𝑼𝑺𝑨𝑩𝑳𝑬 𝑬𝑵 𝑮𝑹𝑼𝑷𝑶𝑺',
    private: '[🧸𝗔𝗗𝗩𝗘𝗥𝗧𝗘𝗡𝗖𝗜𝗔🧸] 𝑼𝑺𝑨 𝑬𝑺𝑻𝑬 𝑪𝑶𝑴𝑨𝑵𝑫𝑶 𝑨𝑳 𝑪𝑯𝑨𝑻 𝑷𝑹𝑰𝑽𝑨𝑻𝑬 𝑫𝑬 𝑺𝑨𝑴𝑴𝒀-𝑩𝑶𝑻-𝑴𝑫',
    admin: '[🧸𝗔𝗗𝗩𝗘𝗥𝗧𝗘𝗡𝗖𝗜𝗔🧸] 𝑳𝑶 𝑺𝑰𝑬𝑵𝑻𝑶 𝑬𝑺𝑻𝑬 𝑪𝑶𝑴𝑨𝑵𝑫𝑶 𝑬𝑺 𝑷𝑨𝑹𝑨 𝑨𝑫𝑴𝑰𝑵𝑺 𝑫𝑬𝑳 𝑮𝑹𝑼𝑷𝑶',
    ...
    restrict: '[🧸𝗔𝗗𝗩𝗘𝗥𝗧𝗘𝗡𝗖𝗜𝗔🧸] 𝑬𝑳 𝑪𝑶𝑴𝑨𝑵𝑫𝑶 𝑬𝑺𝑻𝑨 𝑹𝑬𝑺𝑻𝑹𝑰𝑵𝑮𝑰𝑫𝑶 𝑷𝑶𝑹 𝑳𝑶𝑺 𝑶𝑾𝑵𝑬𝑹𝑺 𝒀 𝑺𝑻𝑨𝑭𝑭 𝑫𝑬 𝑺𝑨𝑴𝑴𝒀-𝑩𝑶𝑻-𝑴𝑫',
  }[type];
  const aa = {quoted: m, userJid: conn.user.jid};
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '🧸 𝐀𝐕𝐈𝐒𝐎 - 𝐀𝐋𝐄𝐑𝐓𝐀', body: ' 𝑺𝒂𝒎𝒎𝒚-𝑩𝒐𝒕-𝑴𝑫', thumbnail: imagen1, sourceUrl: global.md}}}}, aa);
