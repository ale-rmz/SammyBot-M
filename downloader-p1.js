...
if (!text) throw `*[❗𝐈𝐍𝐅𝐎❗] 𝙵𝙰𝙻𝚃𝙰 𝙴𝙻 𝙽𝙾𝙼𝙱𝚁𝙴 𝙳𝙴 𝙻𝙰 𝙲𝙰𝙽𝙲𝙸𝙾𝙽 🎧, 𝙸𝙽𝙶𝚁𝙴𝚂𝙴 𝙴𝙻 𝙲𝙾𝙼𝙰𝙽𝙳𝙾 𝙼𝙰𝚂 𝙴𝙻 𝙽𝙾𝙼𝙱𝚁𝙴 𝙳𝙴 𝚄𝙽𝙰 𝙲𝙰𝙽𝙲𝙸𝙾𝙽*\n\n*—◉ 𝙴𝙹𝙴𝙼𝙿𝙻𝙾:*\n*${usedPrefix + command} 𝙿𝙰𝙿𝙸 𝚆𝙸𝙻𝙾-𝙼𝙸 𝙷𝙸𝚂𝚃𝙾𝚁𝙸𝙰*`
try {
...
let captionvid = `⟣☘︎ 📃 *𝚃𝙸𝚃𝚄𝙻𝙾:* ${yt_play[0].title}
...
⟣☘︎ *_Enviando ${additionalText}, aguarde un momento_*`  
