...
if wget -q https://github.com/Karim-off/DylanBot1/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[1;35m"
git clone https://github.com/Karim-off/DylanBot1.git
...
echo -e "\033[01;32m\033[01mIniciando DylanBot1!!\nStarting CatBot!!\n\033[0m"
npm start