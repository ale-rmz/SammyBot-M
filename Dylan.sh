...
if wget -q https://github.com/ale-rmz/SammyBot-MD/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install -y yarn\ngit clone https://github.com/Karim-off/SammyBot-MD\ncd SammyBot-MD\nyarn install\nnpm install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[1;35m"
git clone https://github.com/ale-rmz/SammyBot-MD.git
...
echo -e "\033[01;32m\033[01mIniciando SammyBot-MD!!\nStarting CatBot!!\n\033[0m"
npm start